...
export type ResolversUnionTypes<RefType extends Record<string, unknown>> = {
  SearchResult: Book | User;
};

/** Mapping of interface types */
export type ResolversInterfaceTypes<RefType extends Record<string, unknown>> = {
  Account: AdminAccount | GuestAccount;
};
...
export type ResolversTypes = {
  ...
  >;
  AdminAccount: ResolverTypeWrapper<AdminAccount>;
  Book: ResolverTypeWrapper<Book>;
  Boolean: ResolverTypeWrapper<Scalars["Boolean"]["output"]>;
  GuestAccount: ResolverTypeWrapper<GuestAccount>;
...
export type AdminAccountResolvers<
  ContextType = any,
  ParentType extends
    ResolversParentTypes["AdminAccount"] = ResolversParentTypes["AdminAccount"],
> = {
...
export type GuestAccountResolvers<
  ContextType = any,
  ParentType extends
    ResolversParentTypes["GuestAccount"] = ResolversParentTypes["GuestAccount"],
> = {
...
export type Resolvers<ContextType = any> = {
  ...
  AdminAccount?: AdminAccountResolvers<ContextType>;
  Book?: BookResolvers<ContextType>;
  GuestAccount?: GuestAccountResolvers<ContextType>;
